     ...
     <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="suppliers.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Suppliers</a>
                    </li>
                    <li>
                        <a href="item.php"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Medicines List</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" style="overflow-y:auto"> 
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <button class="btn btn-default" id="add-new-supplier">Add New Suppliers
                    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
               <div id="suppliers-data" style></div>
...
<?php include_once('modal/add_new_supplier.php'); ?>
...
<script type="text/javascript" src="assets/js/suppliers.js"></script>
<script type="text/javascript">
        $( document ).ready(function() {
            $("#page-wrapper").height($(document).height()-70);
        });
    </script>       
